...
parser.add_argument("-c", "--columns", action="append", help="Columns to keep")
...
if args.columns and "LocusId" not in args.columns:
    args.columns = ["LocusId"] + args.columns
    print("Will keep columns: " + ", ".join(args.columns))
