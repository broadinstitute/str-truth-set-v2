"""Takes the joined variant table generated by the join_per_sample_variant_tables.py script and resets the genotypes that are outside of dipcall confidence regions.
...
Outputs:
- joined variant table with repeat counts reset to missing (eg. "") if the locus is outside of the dipcall confidence region for that sample
"""
...
parser = argparse.ArgumentParser(description="Reset joined variant table genotypes outside of dipcall confidence regions")
